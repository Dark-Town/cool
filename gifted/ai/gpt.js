let Giftedd = async (m, { Gifted, text, fetchJson }) => {
    ...
    try {
        const aiResponse = await fetchJson(`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`);
